    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferencia_de_atendimento', models.CharField(choices=[('W', 'Whatsapp'), ('E', 'Email'), ('A', 'Ambos')], max_length=1)),
                ('endereco', models.TextField()),
                ('cpf', models.CharField(blank=True, max_length=14, null=True, unique=True, validators=[core.validators.validate_cpf])),
            ],
            bases=(models.Model, core.models.CalculaIdadeMixin),
        ),
        migrations.CreateModel(
            name='Turno',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dono', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='animais', to='core.cliente')),
            ],
            bases=(models.Model, core.models.CalculaIdadeMixin),
        ),
        migrations.CreateModel(
